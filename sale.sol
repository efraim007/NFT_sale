...
contract CryptoArteSales is Ownable, Pausable, Destructible {
    ...
    uint[] public donateIds;
    //address[]uint[] public donateTo;
    ...
    */
    function purchaseToken(uint256 _tokenId) public payable whenNotPaused {
        ...
        //require(msg.value == 0.000000001 BNB, "Need to send BNB or HVI" && msg.value == 0.000000001 HVI, "Need to send BNB or HVI");
    ...
    */
    ...
    function setDonateList(address _doanteaddress, uint256 _tokenId) public onlyOwner {
        donateAddress.push(_doanteaddress);
        donateIds.push(_tokenId);
        orgDonates.push(orgDonate({orgNftId: _tokenId,orgAddress:_doanteaddress}));
    }
